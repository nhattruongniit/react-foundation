...
import { createDetectionActivity } from '../utils/createDetectionActivity';
...
function DetectionTabFactory() {
    const [tabState, setTabState] = useState(TAB_STATES.INACTIVE);
...
export default DetectionTabFactory;